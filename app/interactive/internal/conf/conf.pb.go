...
type Bootstrap struct {
	...
	MessageQueue  *MessageQueue          `protobuf:"bytes,3,opt,name=message_queue,json=messageQueue,proto3" json:"message_queue,omitempty"`
...
type MessageQueue struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Kafka         *MessageQueue_Kafka    `protobuf:"bytes,1,opt,name=kafka,proto3" json:"kafka,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MessageQueue) GetKafka() *MessageQueue_Kafka {
	if x != nil {
		return x.Kafka
	}
	return nil
...
type MessageQueue_Kafka struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MessageQueue_Kafka) Reset() {
	*x = MessageQueue_Kafka{}
	mi := &file_conf_conf_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MessageQueue_Kafka) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageQueue_Kafka) ProtoMessage() {}

func (x *MessageQueue_Kafka) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageQueue_Kafka.ProtoReflect.Descriptor instead.
func (*MessageQueue_Kafka) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *MessageQueue_Kafka) GetAddrs() []string {
	if x != nil {
		return x.Addrs
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rmessage_queue\x18\x03 \x01(\v2\x18.kratos.api.MessageQueueR\fmessageQueue\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\fMessageQueue\x124\n" +
	"\x05kafka\x18\x01 \x01(\v2\x1e.kratos.api.MessageQueue.KafkaR\x05kafka\x1a\x1d\n" +
	"\x05Kafka\x12\x14\n" +
	"\x05addrs\x18\x01 \x03(\tR\x05addrsBWZUgithub.com/LEILEI0628/GoWeb-MicroServices/app/user/app/interactive/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*MessageQueue)(nil),        // 3: kratos.api.MessageQueue
	...
	(*MessageQueue_Kafka)(nil),  // 8: kratos.api.MessageQueue.Kafka
	(*durationpb.Duration)(nil), // 9: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	2,  // 1: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	3,  // 2: kratos.api.Bootstrap.message_queue:type_name -> kratos.api.MessageQueue
	...
	8,  // 7: kratos.api.MessageQueue.kafka:type_name -> kratos.api.MessageQueue.Kafka
